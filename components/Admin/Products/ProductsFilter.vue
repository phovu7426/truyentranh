<template>
  <AdminFilter
    ...
    sort-field="sort"
    search-field="search"
    search-placeholder="Tìm theo tên, SKU..."
  ...
  >
    ...
    <template #advanced-filters="{ filters, onChange }">
      ...
      <div>
        <SelectFilter
          v-model="filters.include_variants"
          :options="includeOptions"
          placeholder="Bao gồm biến thể"
          @update:model-value="onChange"
        />
      </div>
      ...
      <div>
        <SelectFilter
          ...
          placeholder="Chọn loại sản phẩm số"
          @update:model-value="onChange"
        />
      </div>
    </template>
