<template>
  <div class="min-h-screen bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
      ...
      <!-- Comic Detail -->
      <div v-else-if="comic" class="bg-white rounded-lg shadow-md overflow-hidden mb-6">
          ...
          <div class="flex-1 p-6">
            ...
            <div class="flex flex-wrap gap-3 mb-4">
              <NuxtLink
                ...
                :to="`/home/comics/${comic.slug}/chapters/${firstChapter.id}`"
      ...
      <!-- Description Section -->
      <div v-if="comic && comic.description" class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                >
                  <td class="px-4 py-3 whitespace-nowrap">
                    <NuxtLink
                      ...
                      :to="`/home/comics/${comic.slug}/chapters/${chapter.id}`"
...
async function loadComic() {
  loading.value = true
  try {
    const response = await apiClient.get(publicEndpoints.comics.showBySlug(route.params.slug as string))
